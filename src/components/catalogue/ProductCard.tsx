...
export function ProductCard({ product, index = 0 }: { product: Product; index?: number }) {
  ...
  return (
    <motion.div
      ...
      className="plate-clip group relative flex flex-col overflow-hidden bg-parchment-100 shadow-plate ring-1 ring-charcoal/5 transition-transform duration-200 hover:-translate-y-1"
    >
